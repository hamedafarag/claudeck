...
browser ──────── WebSocket ──────── server.js ──────── Claude Code SDK
   ...
   │   ├── features/ (chat, voice, sessions) │   ├── agents.json (4 agents)
...
└── public/
    ...
    │   ├── features/      voice-input.css, retro-terminal.css (easter egg)
    ...
    └── js/
        ...
        ├── features/      chat, sessions, projects, home, attachments, voice-input, easter-egg, etc.
